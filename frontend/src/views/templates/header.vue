    ...
    <ul class="navbar-nav">
      ...
      <li v-if="helpdeskCheck" class="nav-item"><a class="nav-link" href="#">Management</a>
        <ul class="navbar-nav-submenu">
          ...
          <li class="nav-item-submenu"><router-link class="nav-link" to="/incidentType">Incident Type Manager</router-link></li>
          <li class="nav-item-submenu"><router-link class="nav-link" to="/incidentUrgency">Incident Urgency Manager</router-link></li>
        </ul>
      </li>
