  ...
  <div>
    <div class="tableHeading">
      <div class="tableHeading-left">
        <span class="tableHeading-text">Team List</span>
      </div>
      <div class="tableHeading-right">
        <button class="swal2-editform swal2-styled" v-on:click="addNewTeam">Add New Team</button>
      </div>
    </div>
    ...
    onRowDoubleClick(params){
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          axios.put(`${config.api}/api/teams/update`, data)
            .then((response) => {
              this.loadData()
              Swal.fire(
                'Done!',
